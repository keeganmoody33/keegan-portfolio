      ...
      <div className="max-w-7xl mx-auto px-4 py-4">
        <div className="flex items-center justify-between mb-3">
          ...
          <a
            ...
            onClick={handleClick}
            className="text-[var(--text-muted)] text-xs hover:text-[var(--accent-lime)] transition-colors"
          >
        ...
        <a
          ...
          rel="noopener noreferrer"
          onClick={handleClick}
          className="flex items-end gap-[3px] h-[48px] group cursor-pointer"
        >
            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  `}
                  style={{ height: hasActivity ? `${Math.max(heightPercent, 12)}%` : '4px' }}
                />
              </div>
            )
          })}
